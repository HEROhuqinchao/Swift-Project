...
var window: UIWindow?
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        self.window?.rootViewController = BCBaseTabBarVC.tabbarWithNavigationStyle()
...
//           reachability?.status = { status in
//               switch status {
//               case .reachable(.wwan):
//                   BCNoticeBar(config: BCNoticeBarConfig(title: "主人,检测到您正在使用移动数据")).show(duration: 2)
//               default: break
//               }
//           }
