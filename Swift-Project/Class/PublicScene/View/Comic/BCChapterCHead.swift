...
typealias BCChapterCHeadSortClosure = (_ button: UIButton) -> Void


class BCChapterCHead: BCBaseCollectionReusableView {
    
    var sortClosure: BCChapterCHeadSortClosure?
