...
class UComicHeadCCell: BCBaseCollectionViewCell {
...
class BCComicHead: UIView {
    
    var detailStatic: ComicStaticModel? {
        didSet {
            guard let detailStatic = detailStatic else { return }
            bgView.kf.setBCImage(urlString: detailStatic.cover, placeholder: UIImage(named: "normal_placeholder_v"))
            coverView.kf.setBCImage(urlString: detailStatic.cover, placeholder: UIImage(named: "normal_placeholder_v"))
...
extension BCComicHead: UICollectionViewDataSource {
