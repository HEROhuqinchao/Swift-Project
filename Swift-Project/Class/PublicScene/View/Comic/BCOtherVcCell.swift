...
class BCOtherVcCell: BCBaseCollectionViewCell {
    ...
    var model: OtherWorkModel? {
        didSet {
            ...
            iconView.kf.setBCImage(urlString: model.coverUrl, placeholder: (bounds.width > bounds.height) ? UIImage(named: "normal_placeholder_h") : UIImage(named: "normal_placeholder_v"))
