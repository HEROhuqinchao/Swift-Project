//
//  BCCollectionViewAlignedFlowLayout.swift
//  BCSwiftDemo
//
...
public class BCCollectionViewAlignedFlowLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: BCCollectionViewAlignedFlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: BCCollectionViewAlignedFlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: BCCollectionViewAlignedFlowLayout) {
    ...
    private func alignToFollowingItem(collectionViewLayout: BCCollectionViewAlignedFlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: BCCollectionViewAlignedFlowLayout) {
    ...
    func alignVertically(collectionViewLayout: BCCollectionViewAlignedFlowLayout) {
